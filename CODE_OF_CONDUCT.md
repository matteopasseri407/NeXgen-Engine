...
This project has a single maintainer, not a moderation team. The maintainer
is responsible for clarifying and enforcing standards of acceptable behavior
...
reported the same way a security vulnerability is: a private GitHub security
advisory on this repo, or email to the address on the maintainer's GitHub
profile (see `SECURITY.md`). All complaints will be reviewed and
